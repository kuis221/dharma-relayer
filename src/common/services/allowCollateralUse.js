import { getNetworkAsync, getDefaultAccount } from './web3Service';
import { getTokenContractBySymbolAsync } from './tokenService'
...
export default async function (amount, token) {
  ...
  await tokenContract.approve(spender, amount, { from: getDefaultAccount() });
}